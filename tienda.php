...
<div class="container">
    ...
    if($result->num_rows > 0){ 
        while($row = $result->fetch_assoc()){ 
            $proImg = !empty($row["imagen"])?'imagenes'.$row["imagen"]:'images/demo-img.png'; 
    ?>
        <div class="card" style="width: 18rem;">
            <img src="<?php echo $proImg; ?>" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title"><?php echo $row["nombre"]; ?></h5>
                <h6 class="card-subtitle mb-2 text-muted">Price: <?php echo CURRENCY_SYMBOL.$row["precio"].' '.CURRENCY; ?></h6>
